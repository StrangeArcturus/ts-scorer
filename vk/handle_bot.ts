...
Внимание, знак восклицательного знака (!) в этой и в следующих командах желателен, но не обязателен
${indent}Для работы с командами с аргументами,
их нужно писать в формате "
добавить
<название предмета>
", записыавя с новой строки отдельно команду, отдельно предмет и отдельно оценки и жеталельно без лишних слов!
...
!дописать -- дописывает оценку к уже существующему предмету, пример использования -- "
!дописать
матеша
4
"
!очистить -- безвозвратно стирает оценки по выбранному предмету, но не удаляет его. Пример -- "
!очистить
инфа
"
...
!текущий_балл -- подсчитывает нынешний балл по выбранному предмету. Пример -- "
!текущий_балл
геометрия"
